  ...
  const sighnuphandler=(e)=>{
    e.preventDefault()
      if (is_valid && pis_valid){
        if (name && city && pin && age && address && gender && address && phone
          && email && password){
              ...
              <div className="split-item-content center-content-mobile reveal-from-left" data-reveal-container=".split-item">
                ...
                <p className="m-0">
                  <form>
                    ...
                    <Input id="newsletter" type="name" hasIcon="right" placeholder="Your Address" name="address" style={{ marginTop: "4%", borderRadius: "20px", borderColor: "grey" }}
                    ...
                    <Input id="newsletter" type="name" hasIcon="right" placeholder="Your Email" name="email" style={{ marginTop: "4%", borderRadius: "20px", borderColor: "grey" }}
                    onChange={ValidateEmail} value={email}>
                    </Input>
                    {is_valid?'':<p>please enter valid email id</p>}
                    <div className="row" style={{ marginTop: "2%" }}>
                        <div className="column" style={{ paddingRight: "1%" }}>
                        <Input id="newsletter" type="password" hasIcon="right" placeholder="New Password" name="password" style={{ marginTop: "4%", borderRadius: "20px", borderColor: "grey" }}
                    ...
                    <br />
                    <center>
                      <button onClick={sighnuphandler} className="button button-primary button-wide-mobile button-sm"  style={{ backgroundColor: "#f1b12a", borderRadius: "20px" }}>Signup</button>
